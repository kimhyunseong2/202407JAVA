...
public class UserService {
	...
	public void writeMsg(String id, String pw, String name) throws Exception {

		if (id == null || id.length() == 0 || pw == null || pw.length() == 0 || name == null || name.length() == 0) {
	...
	public void updateMsg(String id, String pw, String name) throws Exception {
