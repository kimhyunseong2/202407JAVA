...
String num = request.getParameter("num");	// null이면 insert나 update를 하지 말아야 한다
...
%>
	...
	<td><%=mathTmp %></td><td><%=tot %></td><td><%=avg %></td><td><button onclick="location.href='?delete=<%=numTmp %>'">삭제</button>
	</tr>
<%
}
%>
